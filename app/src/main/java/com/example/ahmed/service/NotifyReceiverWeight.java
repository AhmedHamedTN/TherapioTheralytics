...
import com.example.ahmed.ui.ResultActivityWeight;
 ...
 */
public class NotifyReceiverWeight extends BroadcastReceiver{


   /* int NOTIFICATION_ID = 0;
    Context context;
    String sstring = "Tell us about your weight, all it takes is seconds" ;*/
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent service1 = new Intent(context, sendWeightService.class);
       ...
       /* //SharedPreferences prefs = getSharedPreferences(
        ...
        intent = new Intent(context, ResultActivityWeight.class);
        ...
        stackBuilder.addParentStack(ResultActivityWeight.class);
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
                ...
                .setContentTitle("Did your weight change ?")
