...
import com.example.ahmed.ui.ResultActivityMood;
 ...
 */
public class NotifyReceiverMood extends BroadcastReceiver{


    /*int NOTIFICATION_ID = 0;
    Context context;
    String sstring = "Tell us about your mood, all it takes is seconds" ;
*/
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent service1 = new Intent(context, sendMoodService.class);
...
/*        //Toast.makeText(context, "Notifying: ", LENGTH_SHORT).show();
        ...
        intent = new Intent(context, ResultActivityMood.class);
        ...
        stackBuilder.addParentStack(ResultActivityMood.class);
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
                ...
                .setContentTitle("How is your Mood ?")
