 ...
 */
public class NotifyReceiverConsumption extends BroadcastReceiver{
...
*/
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent service1 = new Intent(context, sendConsumptionService.class);
       ...
       /* //SharedPreferences prefs = getSharedPreferences(
        ...
        intent = new Intent(context, ResultActivityConsumption.class);
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
                ...
                .setContentTitle("How about your Alcohol, tobacco consumption? Is there a change?")
