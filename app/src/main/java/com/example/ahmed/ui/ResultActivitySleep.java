 ...
 */
public class ResultActivitySleep extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ResultActivitySleep.this,
                        radioButton.getText(), Toast.LENGTH_SHORT).show();

                state = (String) radioButton.getText();

                new sendResultSleep().execute();
    ...
    public class sendResultSleep extends AsyncTask<Void, Void, Void> {
...
/*
          ...
          /*  String date = new SimpleDateFormat("dd-MM-yyyy").format(new Date());
            ...
            try {
                ...
                String url = Config_URL.URL_STORE_SLEEP;
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new sendResultSleep().execute();
                //Toast.makeText(ResultActivitySleep.this, state, Toast.LENGTH_SHORT).show();
