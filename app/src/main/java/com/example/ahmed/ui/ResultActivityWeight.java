 ...
 */
public class ResultActivityWeight extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ResultActivityWeight.this,
                        radioButton.getText(), Toast.LENGTH_SHORT).show();

                state = (String) radioButton.getText();

                new sendResultWeight().execute();
    ...
    public class sendResultWeight extends AsyncTask<Void, Void, Void> {
...
/*
          ...
          /*  String date = new SimpleDateFormat("dd-MM-yyyy").format(new Date());
            ...
            try {
                ...
                String url = Config_URL.URL_STORE_WEIGHT;
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new sendResultWeight().execute();
                //Toast.makeText(ResultActivityWeight.this, state, Toast.LENGTH_SHORT).show();
