package com.example.ahmed.ui.QuestionnaireBDI;
...
import com.example.ahmed.ui.QuestionnaireBDI.result.Result;
...
public class Beginners extends AppCompatActivity {
    ...
    public static  String scoremsg = "SEND MESSAGE";
...
/*        if (metrics.densityDpi >=240 )
        ...
        builder.setMessage("Do you really want to exit?.").setCancelable(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent intent = new Intent(Beginners.this,MainActivity.class);
    ...
    public void init()
    {
        ...
        Lable1: {	 answerButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                ...
                if(opt1.isChecked()||opt2.isChecked()||opt3.isChecked()||opt4.isChecked()){
                    ...
                    Toast toast= Toast.makeText(getApplicationContext(),
                            "Select At least one Option", Toast.LENGTH_SHORT);
    ...
    public void showQuestion()
    {
        ...
        if(currentQuestion == (questions.length)){
            ...
            if (point>=0 && point<=10) {
                ...
                if(point>=11 && point<=16){
                    state = " Mild mood disturbance ";
            }else
                if(point>=17 && point<=20){
                    state = "Borderline clinical depression";
            }else
                if(point>=21 && point<=30){
                    state = "Moderate depression";
            }else
                if(point>=31 && point<=40){
                    state = "Severe depression";
                }
            else
                if(point>=40){
                    state = "Extreme depression";
                }

            scoremsg= Integer.toString(point);
            currentQuestion =0;
